...
namespace NewTxtRPG.Entitys
{
    ...
    internal static class Items
    {
        public static readonly ItemInfo[] ItemList =
        {
            ...
            new ItemInfo(14, ItemType.Consumables, "?"          ,       1,  "?", 0, 0, 0, 0),
            // 드랍 전용 아이템
            new ItemInfo(15, ItemType.Dropped, "도토리", 10, "귀여운 다람쥐가 볼에 빵빵하게 넣고 다니는 도토리입니다.", 0, 0, 0, 0),
            new ItemInfo(16, ItemType.Dropped, "토끼고기", 10, "귀여운 토끼의 복실복실한 털을 벗겨내 도축한 생고기입니다.", 0, 0, 0, 0),
            new ItemInfo(17, ItemType.Dropped, "박쥐의 날개", 30, "그닥 안귀여운 박쥐에게서 잘라낸 날개입니다.", 0, 0, 0, 0),
            new ItemInfo(18, ItemType.Dropped, "소고기", 50, "우리 모두가 취직하면 사먹고 싶어하는 투쁠 채끝살입니다.", 0, 0, 0, 0),
            new ItemInfo(19, ItemType.Dropped, "우유", 500, "어떤 소가 '날 아무리 짜봐야 우유 안나와'라고 했다지만, 짜니까 나왔네요?", 0, 0, 0, 0),
            new ItemInfo(20, ItemType.Equipment, "토끼 잠옷", 5000, "만렙토끼 보스 클리어 보상 아이템입니다. 귀여운 잠옷입니다.", 0, 22, 0, 0),
            new ItemInfo(21, ItemType.Equipment, "뼈다귀", 10000, "??? 보스 클리어 보상 아이템입니다. 들어서 무기로 쓸수 있습니다.", 45, 0, 0, 0)
        };
    }
}
